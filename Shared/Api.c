            ...
            .then(function(data) {
                ...
                fetch("https://matchmaker.api.rivet.gg/v1/lobbies/join", {
                    "headers": {
                        "Authorization":
                            // clang-format off
                            "Bearer pub_prod.eyJ0eXAiOiJKV1QiLCJhbGciOiJFZERTQSJ9.CMrvtrvoMhDKl_L98jEaEgoQy-TfLd3_SoeKmjhRkm_PPiIWGhQKEgoQSIFSwo_HT6GIhaljrDftEw.ItEJUaS3G8O1hvF9avQKBfMcjM1evFivNHoO7RUnXaMbVUC5lIbYLwktrhRqtlCZDaRaR626fzZv_h76cNSkAw"
                        // clang-format on
                    },
                    "mode": "no-cors",   
                    "method": "POST",
